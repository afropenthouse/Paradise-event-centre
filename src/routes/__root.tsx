  ...
  head: () => ({
    meta: [
      ...
      { title: "Paradise Event Centre — Lagos Premier Event Venue" },
      {
        name: "description",
        content:
          "Paradise Event Centre is Lagos&apos; premier venue for weddings, conferences, birthdays and concerts. Located in Yaba with capacity for up to 2,000 guests.",
      },
      { name: "author", content: "Paradise Event Centre" },
      { property: "og:title", content: "Paradise Event Centre — Lagos Premier Event Venue" },
      {
        property: "og:description",
        content:
          "Elegant event hall in Yaba, Lagos. Weddings, conferences, concerts and celebrations for up to 2,000 guests.",
      },
